...
class MultiTimeframeCryptometerSystem:
    ...
    async def get_health_status(self) -> Dict[str, Any]:
        """Get health status for the MultiTimeframeCryptometerSystem"""
        try:
            # Check API connectivity
            api_healthy = bool(self.api_key)
            
            # Check if we can make requests
            can_request = hasattr(self, 'session') and self.session is not None
            ...
            return {
                ...
                "api_configured": api_healthy,
                "session_available": can_request,
                "service": "MultiTimeframeCryptometerSystem",

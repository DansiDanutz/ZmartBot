...
# from src.agents.orchestration.orchestration_agent import OrchestrationAgent  # COMMENTED - folder doesn't exist
# from src.agents.position_lifecycle_orchestrator import position_orchestrator  # COMMENTED - folder doesn't exist

# Import security modules - COMMENTED - folder doesn't exist
...
# orchestration_agent: Optional[OrchestrationAgent] = None  # COMMENTED - not available
...
async def lifespan(app: FastAPI):
    ...
    try:
        # orchestration_agent = OrchestrationAgent()  # COMMENTED - not available
    ...
    try:
        # await position_orchestrator.start_monitoring()  # COMMENTED - not available
        pass
    ...
    try:
        # await position_orchestrator.stop_monitoring()  # COMMENTED - not available
        pass
...
# app.add_middleware(SecurityHeadersMiddleware)  # COMMENTED - not available
...
# Add rate limiting
# app.state.limiter = limiter  # COMMENTED - not available

# Rate limit exception handler wrapper
async def rate_limit_exception_handler(request: Request, exc: Exception) -> Response:
    if isinstance(exc, RateLimitExceeded):
        # return await rate_limit_handler(request, exc)  # COMMENTED - not available
...
from src.routes import (
    ...
    additional_health, additional_signals, chatgpt_alerts, alerts, manus_webhook
)
...
app.include_router(manus_webhook.router, tags=["manus"])  # Manus AI Webhook Integration

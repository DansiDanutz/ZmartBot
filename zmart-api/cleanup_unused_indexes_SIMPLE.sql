-- ============================================================================
-- ZMARTBOT DATABASE OPTIMIZATION - UNUSED INDEX CLEANUP (SIMPLE VERSION)
-- ============================================================================
-- Purpose: Remove unused indexes to free storage and improve write performance
-- Date: 2025-10-01
-- Version: SIMPLE (for Supabase Dashboard - no CONCURRENTLY needed for DROP)
-- ============================================================================

-- BATCH 1: Alert & Report Indexes (15 indexes)
DROP INDEX IF EXISTS public.unique_active_symbol;
...
-- BATCH 5: ZmartyChat Indexes (11 indexes)
...
-- BATCH 6: Trading & Portfolio Indexes (15 indexes)
...
-- BATCH 7: Service Indexes (18 indexes)
...
-- BATCH 8: Miscellaneous Indexes (11 indexes)
...
-- Success! All unused indexes removed.

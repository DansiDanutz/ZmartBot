...
const ZmartyService = {
    ...
    auth: {
        ...
        async register(email, password, tier = 'free') {
            try {
                console.log('🧠 ZmartyBrain: Creating user account...');
        ...
        async createTradingProfile(userId, email, tier) {
            try {
                console.log('🤖 ZmartBot: Creating trading profile...');
...
window.addEventListener('load', async () => {
    ...
    if (session) {
        ...
        console.log('📊 User tier:', session.user.user_metadata.tier);
...
console.log('✅ Dual Supabase Architecture Initialized');
console.log('🧠 ZmartyBrain: User Management');
console.log('🤖 ZmartBot: Crypto Trading');
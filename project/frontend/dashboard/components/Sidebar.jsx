  ...
  const navigationGroups = [
    {
      items: [
        ...
        { icon: Bell, label: 'Live Alerts', active: currentPage === 'enhanced-alerts', page: 'enhanced-alerts' },
        { icon: Bell, label: 'Alerts', active: currentPage === 'alerts', page: 'alerts' },
        { icon: BookOpen, label: 'Roadmap', active: currentPage === 'roadmap', page: 'roadmap' }
      ]
    },
    {
      items: [

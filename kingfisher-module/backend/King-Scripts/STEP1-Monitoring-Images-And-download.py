#!/usr/bin/env python3
"""
STEP 1: MONITORING IMAGES AND DOWNLOAD
Find and download all images from @thekingfisher_liqmap_bot
Saves as numbered files: 1.jpg, 2.jpg, 3.jpg, etc.
"""
            ...
            if msg.date and msg.date > datetime.now(msg.date.tzinfo) - timedelta(hours=1):
                ...
                if msg.sender:
                    ...
                    if 'kingfisher' in str(sender_username).lower() or sender_id == 5646047866:
                        if msg.photo:
                            found_images += 1
                            filename = f"{DOWNLOAD_FOLDER}/{found_images}.jpg"
